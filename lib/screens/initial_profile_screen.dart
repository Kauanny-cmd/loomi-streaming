                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: Container(
                                ...
                                child: const Center(
                                  child: Icon(Icons.camera_alt_outlined,
                                      color: Color(0xFFBB86FC), size: 24),
                                ),
                              ),
                            ),
                        ...
                        TextFormField(
                          ...
                          decoration: CustomTextFieldDecoration.build('Your name'),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            onPressed: () async {
                              final response = await editUser(nameController.text);
                              if(response == "Ok"){
                            ...
                            child: const Text("Continue",
                                style: TextStyle(fontSize: 16, color: Color((0xFFBB86FC)))),
                          ),
                        ),
